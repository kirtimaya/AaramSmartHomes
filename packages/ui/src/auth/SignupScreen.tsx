...
import { Mail, Lock, User, ArrowRight, Loader2, AlertCircle, CheckCircle2, Leaf } from '../icons';
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-primary/20">
      ...
      >
        <div className="text-center mb-8 space-y-3">
          ...
          >
            <img src="/images/aaram-logo.png" alt="Aaram" className="w-7 h-7 object-contain transition-transform group-hover:scale-110" />
