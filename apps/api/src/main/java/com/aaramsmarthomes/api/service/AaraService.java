...
public class AaraService {
    ...
    private String buildSystemPrompt(UserPrincipal principal, String context) {
        ...
        String base = """
            ...
            You help residents, tenants, guests, and admins with property-related questions.
        ...
        String rolePrompt = switch (principal.role()) {
            case ADMIN -> base + "You are assisting an admin. Help with tenant management, financial summaries, maintenance tickets, and operational questions.";
            case TENANT -> base + "You are assisting a tenant. Help with rent queries, maintenance requests, amenity information, and living tips.";
